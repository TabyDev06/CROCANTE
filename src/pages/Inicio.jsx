...
function Inicio() {
    ...
    return (
        <>
            ...
            <div>
                <div>
                    <h3 className="text-center font-marcellus text-2xl m-5">Todos Somos una Familia</h3>
                </div>
                <div className="flex mx-50 items-center justify-center gap-30">
                    <div className="flex flex-col text-center gap-3">
                        <img src={BestChef} alt="The Best Chef" className="w-50 aspect-3/2 object-cover rounded-lg hover:scale-105 duration-500 cursor-pointer"
                        />
                        <h4 className="font-lekton font-bold">Nuestro Chef Estrella</h4>
                    </div>
                    <div className="flex flex-col text-center gap-3">
                        <img src={MomentsThatCreak} alt="Moments That Creak" className="w-50 aspect-3/2 rounded-lg hover:scale-105 duration-500 cursor-pointer" />
                        <h4 className="font-lekton font-bold">Momentos que Crujen</h4>
                    </div>
                    <div className="flex flex-col text-center gap-3">
                        <img src={OurVariedMenu} alt="Our Varied Menu" className="w-50 aspect-3/2 rounded-lg hover:scale-105 duration-500 cursor-pointer" />
